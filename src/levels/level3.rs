...
pub fn setup(builder: &mut SceneBuilder) {
    ...
    // 1 - 7
    builder.spawn_wall_from_to(Vec2::new(-30.0, -30.0) * S, Vec2::new(0.0, 30.0) * S);
    builder.spawn_wall_from_to(Vec2::new(-1.0, -4.0) * S, Vec2::new(3.0, -1.0) * S);
    builder.spawn_wall_from_to(Vec2::new(-1.0, 6.0) * S, Vec2::new(10.0, 30.0) * S);
    builder.spawn_wall_from_to(Vec2::new(-1.0, -3.0) * S, Vec2::new(12.0, -30.0) * S);
    builder.spawn_wall_from_to(Vec2::new(9.0, 1.0) * S, Vec2::new(10.0, 20.0) * S);
    builder.spawn_wall_from_to(Vec2::new(9.0, 7.0) * S, Vec2::new(16.0, 30.0) * S);
    ...
    builder.spawn_wall_from_to(Vec2::new(12.0, -3.3) * S, Vec2::new(15.0, -30.0) * S);
    builder.spawn_wall_from_to(Vec2::new(17.0, 0.2) * S, Vec2::new(28.0, 2.0) * S);
    builder.spawn_wall_from_to(Vec2::new(16.0, 10.0) * S, Vec2::new(60.0, 60.0) * S);
    ...
    // 16 - 19
    builder.spawn_wall_from_to(Vec2::new(32.0, -60.0) * S, Vec2::new(60.0, 60.0) * S);
    builder.spawn_wall_from_to(Vec2::new(15.0, -60.0) * S, Vec2::new(60.0, -9.0) * S);
